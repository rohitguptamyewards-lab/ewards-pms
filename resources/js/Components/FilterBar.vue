    ...
    <div class="flex flex-wrap items-end gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
        <div v-for="(opts, key) in options" :key="key" class="min-w-[160px]">
            ...
            <select
                ...
                v-model="local[key]"
                @change="apply"
                class="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-[#4e1a77] focus:ring-1 focus:ring-[#4e1a77]"
            >
            ...
            <input
                ...
                type="date"
                @change="apply"
                class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-[#4e1a77] focus:ring-1 focus:ring-[#4e1a77]"
            />
            <input
                v-else
                v-model="local[key]"
