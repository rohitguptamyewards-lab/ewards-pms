...
const colorMap = {
    task: {
        ...
        in_progress: 'bg-[#e8ddf0]  text-[#4e1a77]  ring-1 ring-blue-200',
    ...
    request: {
        ...
        clarification_needed:  'bg-amber-100  text-amber-700  ring-1 ring-amber-200',
    ...
    project: {
        ...
        completed: 'bg-[#e8ddf0]   text-[#4e1a77]   ring-1 ring-blue-200',
    },
    feature: {
...
const dotMap = {
    open:              'bg-slate-400',
    in_progress:       'bg-[#4e1a77]',
    blocked:           'bg-red-500',
    done:              'bg-green-500',
    received:          'bg-slate-400',
    under_review:      'bg-yellow-500',
    clarification_needed: 'bg-amber-500',
    linked:            'bg-blue-500',
