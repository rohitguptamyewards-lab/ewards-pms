            ...
            <div v-for="member in activeOnboarding" :key="member.id"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-[#ece1ff] text-sm font-bold text-[#5e16bd]">
                ...
                <div class="mb-3 h-2 rounded-full bg-gray-100 overflow-hidden">
                    <div class="h-full rounded-full bg-[#5e16bd] transition-all" :style="{ width: getProgress(member) + '%' }"></div>
                </div>
