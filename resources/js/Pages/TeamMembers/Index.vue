    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link
                ...
                class="group rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:border-[#5e16bd]/40 hover:shadow-md transition-all"
            >
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2">
                            <p class="font-semibold text-gray-900 group-hover:text-[#5e16bd] transition-colors truncate">{{ member.name }}</p>
                            <span
