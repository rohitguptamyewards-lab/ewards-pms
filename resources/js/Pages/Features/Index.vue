...
const statusConfig = {
    ...
    in_progress:       { classes: 'bg-[#e8ddf0] text-[#4e1a77]',     label: 'In Progress' },
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        >
                            <td class="px-5 py-3.5">
                                <Link :href="`/features/${feature.id}`" class="font-semibold text-[#4e1a77] group-hover:underline">
                                    {{ feature.title }}
                                </Link>
                            </td>
                        ...
                        <tr v-if="!features.data?.length">
                            <td colspan="8" class="px-5 py-12 text-center">
                                ...
                                <Link v-if="isManager" href="/features/create" class="mt-2 inline-block text-sm text-[#4e1a77] hover:underline">
