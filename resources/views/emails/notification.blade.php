...
<head>
    ...
    <style>
        ...
        .header { background: #5e16bd; padding: 24px 30px; }
        ...
        .btn { display: inline-block; background: #5e16bd; color: #ffffff !important; text-decoration: none; padding: 10px 24px; border-radius: 8px; font-size: 14px; font-weight: 600; }
